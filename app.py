...
if option == 'Stock Predictions':
    stock_input = st.text_input('Enter Stock Symbol or Name', '').upper()

    if stock_input:
        # Filter suggestions based on user input
        suggestions = [item for item in symbols + names if stock_input in item.upper()]
    ...
    stock_input = st.text_input('Enter Your Stock', '').upper()
