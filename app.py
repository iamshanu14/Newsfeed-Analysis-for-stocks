...
if option == 'Stock Predictions':
    stock = st.multiselect('Enter Stock Symbol', stock_options, default=['AAPL'])

    if stock:
        stock_symbol = stock[0]  # Get the first selected stock
    ...
    stock = st.multiselect('Enter Your Stock', stock_options, default=['AAPL'])
